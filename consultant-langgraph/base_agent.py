"""
Base Agent class for all agents in the LangGraph system
"""
...
class BaseAgent:
    """
    Base class for all agents in the WorldQuant Alpha Consultant system
    Provides common utilities for logging, file I/O, and ID generation
    """
    ...
    def __init__(self, name: str, config: Optional[Dict] = None):
        ...
        Args:
            name: Agent name (e.g., 'paper_research', 'idea_agent')
    ...
    def load_json(self, file_path: str) -> Any:
        ...
        Returns:
            Loaded data (dict, list, etc.) or empty list if file doesn't exist
        """
